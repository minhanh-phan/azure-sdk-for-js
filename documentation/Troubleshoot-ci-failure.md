...
For new service the error usually happens, fix spelling in code or in markdown in [`.vscode/cspell.json`](../.vscode/cspell.json). See an example in [devcenter PR](https://github.com/chrissmiller/azure-sdk-for-js/commit/ef18dccae59e98185e3854f8b087230b65735744).
