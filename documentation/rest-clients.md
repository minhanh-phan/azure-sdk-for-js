...
As an installation note, the `@azure/identity` library is not a dependency of this library. Please run `npm install @azure/identity` (or `pnpm add @azure/identity`) before using AAD authentication
